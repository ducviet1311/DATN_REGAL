...
public class BanHangController {
    ...
    public ResponseEntity<?> taoDonHang(@RequestBody DonHangRequest request, HttpServletRequest httpServletRequest) {
        ...
        hoaDon.setTenKhachHang(request.getTenNguoiNhan() != null ? request.getTenNguoiNhan() : khachHang.getHoVaTen());
        hoaDon.setSoDienThoai(request.getSdtNguoiNhan() != null ? request.getSdtNguoiNhan() : khachHang.getSoDienThoai());
