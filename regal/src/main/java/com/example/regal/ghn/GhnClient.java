...
public class GhnClient {
    ...
    public Map<String, Object> calculateShippingFee(Integer toDistrictId, String toWardCode, Integer khoiLuong) {
        ...
        shippingData.put("weight", khoiLuong);
